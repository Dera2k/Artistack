    ...
    <div class="mx-auto flex justify-between py-4 px-5">
        ...
        <nav>
            <ul class="flex space-x-7 text-white  font-bold text-lg">
                <li>
                    <a href="{{ route('home') }}" class="hover:text-orange-400 hover:underline {{request()->is('/') ? "text-orange-400 font-bold": " "}}">Home
                    </a>
                </li>
                <li>
                    <a href="{{ route('artworks.index') }}" class="hover:text-orange-400 hover:underline {{request()->is('artworks*') ? "text-orange-400" : " "}}">Artworks
                    </a>
                </li>
            </ul>
        </nav>
